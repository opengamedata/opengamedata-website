        <footer>
            <div class="row">
                <div id="footer-ogd" class="col mt-5 mb-5">
                ...
                <div class="col-1 vr-wrapper">
                    <div class="vr"></div>
                </div>
                <div id="footer-uw-wcer" class="col">
                    ...
                    <p class="mt-5"><strong>Funding Provided By:</strong></p>
                    <img src="assets/images/logos/nsf-logo.png" alt="National Science Foundation">
                    <img class="ms-3" src="assets/images/logos/the-learning-agency-logo.png" alt="The Learning Agency">
                    <img class="ms-3" src="assets/images/logos/tools-competition-logo.png" alt="Tools Competition">
                </div>
            </div>           
        </footer>
    </body>

...
export var FILE_SERVER = 'https://opengamedata.fielddaylab.wisc.edu';

// list of games with downloadable datasets
export var game_list = ['AQUALAB', 'BACTERIA', 'BALLOON', 'CRYSTAL', 'CYCLE_CARBON', 'CYCLE_NITROGEN', 'CYCLE_WATER', 'EARTHQUAKE', 'JOWILDER', 'LAKELAND', 'MAGNET', 'WAVES', 'WIND', 'SHADOWSPECT', 'SHIPWRECKS'];
...
export var thumbs = {
     ...
     */
    // open game data core
};export var API_ORIGIN = 'https://fieldday-web.wcer.wisc.edu/wsgi-bin/opengamedata.wsgi/';

// list of games that can be visualized in the Dashboard (used in VisForm)
export var vis_games = ['AQUALAB', 'SHIPWRECKS'];

// list of API call params for each game
export var url_search_metrics = {
    'AQUALAB': ['TopJobCompletionDestinations', 'ActiveJobs', 'JobsAttempted', 'TopJobSwitchDestinations', 'PlayerSummary', 'PopulationSummary', 'JobsCompleted', 'SessionID', 'SessionDuration'],
    'SHIPWRECKS': ['TopJobCompletionDestinations', 'ActiveJobs', 'JobsAttempted', 'PlayerSummary', 'PopulationSummary', 'JobsCompleted', 'SessionID', 'SessionDuration']

    // when fetching timeline from the graph, what type of timeline each game supports (either 'player' or 'session')
};export var timeline_url_path = {
    'AQUALAB': 'player',
    'SHIPWRECKS': 'session'

    // specifies what event types to display when timeline is initialized
};export var initial_timeline_filter_options = {
...
export var color_20 = ["#0cc0aa", "#fc2c44", "#70ce57", "#fb57f9", "#2cf52b", "#c972bd", "#e5ea53", "#f6248f", "#d8fbc9", "#e56c56", "#77d1fd", "#ad7947", "#2282f5", "#f6bb86", "#846dff", "#798a58", "#f7c5f1", "#458da6", "#fbbd13", "#8d7ca6"];
export var color_16 = ["#75eab6", "#f92e5d", "#0ca82e", "#fa63d5", "#b3e61c", "#8b6fed", "#51f310", "#d47389", "#05957a", "#f17e45", "#3588d1", "#fbd127", "#bbc3fe", "#799d10", "#4bd6fd", "#957e84"];